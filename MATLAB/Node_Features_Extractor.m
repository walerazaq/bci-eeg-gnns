...
switch filepath
    ...
    case 'Beta'
        data_path = '/mnt/scratch2/users/asanni/EEG/BetaTrials/';
    case 'Delta'
        data_path = '/mnt/scratch2/users/asanni/EEG/DeltaTrials/';
    case 'Theta'
        data_path = '/mnt/scratch2/users/asanni/EEG/ThetaTrials/';
    case 'Gamma'
        data_path = '/mnt/scratch2/users/asanni/EEG/GammaTrials/';
    case 'overAll'
